"""Add CASCADE DELETE to candidate_reviews.candidate_id foreign key
...
revision = "202609221002"
down_revision = "202609221001"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.drop_constraint("fk_candidate_reviews_candidate_id", "candidate_reviews", type_="foreignkey")
    
    # Recreate the foreign key constraint with ondelete="CASCADE"
    op.create_foreign_key(
        "fk_candidate_reviews_candidate_id",
        "candidate_reviews",
        "candidates",
        ["candidate_id"],
        ["id"],
